...
@echo ${CL_GRN}"target asm:"${CL_RST}" $(PRIVATE_MODULE) <= $<"
...
@echo ${CL_GRN}"target ObjC:"${CL_RST}" $(PRIVATE_MODULE) <= $<"
...
@echo ${CL_PFX}"$($(PRIVATE_PREFIX)DISPLAY) $(PRIVATE_COMPILER_ID) C:"${CL_RST}" $(PRIVATE_MODULE) <= $<"
...
@echo ${CL_PFX}"target Java:"${CL_RST}" $(PRIVATE_MODULE) ($(PRIVATE_CLASS_INTERMEDIATES_DIR))"
...
@echo ${CL_PFX}"target Generated:"${CL_RST}" $(PRIVATE_MODULE) <= $<"
@mkdir -p $(dir $@)
